...
";
    ...
    private static string DumpSource(EnumLikeData data)
    {
        ...
        var publicMembers = data.Members.Where(x => x.Accessibility == "public").ToArray();
...
{{
    ...
    {{
        ...
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly {data.Name}[] _allValuesInternal = new[]
        {{
").AppendForeach(members, m =>
@$"            {m.Name},
").Append(
$@"        }};

        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly {data.Name}[] _allValues = new[]
        {{
").AppendForeach(publicMembers, m =>
@$"            {m.Name},
").Append(
$@"        }};

        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly string[] _allNamesInternal = new[]
        {{
").AppendForeach(members, m =>
@$"            ""{m.Name}"",
").Append(
$@"        }};
        ...
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly string[] _allNames = new[]
        {{
").AppendForeach(publicMembers, m =>
@$"            ""{m.Name}"",
").Append(
$@"        }};
        ...
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly (string Name, {data.Name} Value)[] _allNameValuesInternal = new[]
        {{
").AppendForeach(members, m =>
...
$@"        }};
        ...
        [global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)]
        private static readonly (string Name, {data.Name} Value)[] _allNameValues = new[]
        {{
").AppendForeach(publicMembers, m =>
@$"            (Name: ""{m.Name}"", Value: {m.Name}),
").Append(
...
$@"        /// <summary>{m.Description}</summary>
        {m.Accessibility} static {data.Name} {m.Name} => new {data.Name}(({data.UnderlyingType}){m.Value});
").Append($@"

        private {data.Name}({data.UnderlyingType} value) => _value = value;

        internal static global::System.ReadOnlyMemory<{data.Name}> AllValuesInternal() => _allValuesInternal;

        internal static global::System.ReadOnlyMemory<string> AllNamesInternal() => _allNamesInternal;

        internal static global::System.ReadOnlyMemory<(string Name, {data.Name} Value)> AllNameValuesInternal() => _allNameValuesInternal;

        public static global::System.ReadOnlyMemory<{data.Name}> AllValues() => _allValues;

        public static global::System.ReadOnlyMemory<string> AllNames() => _allNames;

        public static global::System.ReadOnlyMemory<(string Name, {data.Name} Value)> AllNameValues() => _allNameValues;
