...
namespace Elffy
{
    public class CameraMouse : FrameObject
    {
        ...
        private void MoveCamera(float thetaRad, float phiRad)
        {
            ...
            var alpha = new Angle(p0.X / p0.Xz.Length, p0.Z / p0.Xz.Length);    // XZ平面への正射影ベクトルとZ軸との角
            ...
            _camera.Position = target + p1;
            System.Diagnostics.Debug.WriteLine(_camera.Direction);
            //_camera.LookAt(target, target + p1);
        }
