...
namespace Elffy.Shading
{
    internal sealed class PBRDeferedRenderingPostProcess : PostProcess
    {
        ...
        internal PBRDeferedRenderingPostProcess(IGBuffer gBuffer, ILightBuffer lightBuffer)
        {
            _gBuffer = gBuffer;
...
void main()
{
    ...
    vec4 lPosWorld = texelFetch(_lightPosSampler, 0, 0);
    ...
    vec3 lColor = texelFetch(_lightColorSampler, 0, 0).rgb; // light color
